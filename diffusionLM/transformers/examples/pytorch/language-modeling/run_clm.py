...
def get_corpus_rocstory(data_args):
    ...
    if data_args.experiment.startswith('roc') and data_args.task == 'infill':
        ...
        tokenizer = nlp.tokenizer
        #path = f'{data_args.e2e_train}/src1_train.txt'
        path = './datasets/e2e_data/src1_train.txt'
        ...
        nlp = English()
        ### Modified codes ###
        #tokenizer_text= nlp.tokenizer
        #tokenizer = BasicSmilesTokenizer() 
        #########################

        tokenizer = nlp.tokenizer
        #path = f'{data_args.e2e_train}/src1_train.txt'
        #path = '/home/ec2-user/SageMaker/diffusion_models/Diffusion-LM/datasets/ROCstory/roc_train_labeled.txt'
        #path = '/home/ec2-user/SageMaker/diffusion_models/Diffusion-LM/datasets/e2e_data_original/src1_train.txt'
        path = '/home/ec2-user/SageMaker/diffusion_models/Diffusion-LM/datasets/e2e_data/src1_train.txt'
        vocab_lst = []
        with open(path, 'r') as ff:
            for row in ff:
                ...
                ### Modified codes ###
                word_lst = [x.text for x in tokenizer(word_lst)]
                #word_lst = tokenizer.tokenize(word_lst)
                ########################
                ...
                for mode in ordered_:
                    ...
                    #src_lst2 = [x.text for x in tokenizer_text(src_lst3)]
                    ######################
    ...
    #### Added codes ####
    #vocab_dict["conductivity"] = len(vocab_dict)
    #vocab_dict[":"] = len(vocab_dict)
    #vocab_dict["low"] = len(vocab_dict)
    #vocab_dict["high"] = len(vocab_dict)
    
    print("first vocab_dict:")
    print(vocab_dict)
...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        ############# LOAD MODELS for controllable classifier ##############
            ...
            print(f"loading model from {path_learned} ")
